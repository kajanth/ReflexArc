...
class NetworkProbeSensor:
    ...
    async def monitor(self):
        ...
        # ⚡ Bolt: Offload synchronous socket connections to background threads
        # and execute them concurrently to prevent event loop blocking and reduce
        # total latency from O(N) to O(1).
        tasks = [
