...
- **[CONNECTION_POOLING.md](docs/CONNECTION_POOLING.md)** - Database connection pooling configuration and best practices
- **[EMBEDDING_MODEL_CONFIGURATION.md](docs/EMBEDDING_MODEL_CONFIGURATION.md)** - Embedding model setup and caching
- **[MCP_TOOL_CONFIGURATION.md](docs/MCP_TOOL_CONFIGURATION.md)** - MCP tool timeout handling and configuration
- **[ADAPTIVE_POLLING.md](docs/ADAPTIVE_POLLING.md)** - Adaptive sensor polling implementation
